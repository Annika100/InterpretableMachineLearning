...
pdp = FeatureEffect$new(pred.cardiovascular, "ap_hi", method = "pdp")

p1 = pdp$plot() 

pdp$set.feature("cholesterol")
p2 = pdp$plot() 
...
# PDP for Feature Interaction of two Features
pd = FeatureEffect$new(pred.cardiovascular, c("ap_hi", "weight"), method = "pdp") 
pd$plot() 
